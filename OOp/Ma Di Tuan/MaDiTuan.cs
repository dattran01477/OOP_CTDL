 ...
 * Class: Mã Đi Tuần
 * Lớp dùng để khởi tạo, tìm nước đi, đường đi và tọa độ từng bước di
 * của quân Mã                                                           */
/************************************************************************/
...
{
    //Cau truc mot nuoc di cua quan Ma
    ...
    class MaDiTuan
    {
        ...
        private int[] dx        = new int[8];                   //Do doi x
        private int[] dy        = new int[8];                   //Do doi y
            ...
            else
            {
                if (!ngung)
                {
                    ...
                    if (soNuocDi > 0)
                    {
                        ...
                        //lưu đường đi của quân Mã và tọa độ bước đi của nó
                        for (i = 0; i < soNuocDi; i++)
                        {
                            ...
                            TimDuong(luaChon[i].x, luaChon[i].y, buoc + 1);//đê quy
